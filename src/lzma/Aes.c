...
static Byte Sbox[256] = { 0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30,
    0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76, 0xca, 0x82, 0xc9, 0x7d, 0xfa, 0x59,
    ...
    ,
...
void MY_FAST_CALL Aes_SetKey_Enc (UInt32* w, const Byte* key, unsigned keySize) {
    ...
    for (; i < wSize; i++) {
        ...
        if (rem == 0)
            t = Ui32 (Sbox[gb1 (t)] ^ Rcon[i / keySize], Sbox[gb2 (t)],
            Sbox[gb3 (t)], Sbox[gb0 (t)]);
...
void MY_FAST_CALL Aes_SetKey_Dec (UInt32* w, const Byte* key, unsigned keySize) {
    ...
    for (i = 0; i < num; i++) {
        UInt32 r = w[i];
        w[i]     = D[Sbox[gb0 (r)]] ^ D[0x100 + Sbox[gb1 (r)]] ^
        D[0x200 + Sbox[gb2 (r)]] ^ D[0x300 + Sbox[gb3 (r)]];
    }
}
